...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_CREATE2 = "CREATE TABLE list (_id integer primary key autoincrement, name VARCHAR(255),username_fk VARCHAR(255),FOREIGN KEY (username_fk) REFERENCES user(username));";
    private static final String DATABASE_CREATE3 = "CREATE TABLE product (_id integer primary key autoincrement, name VARCHAR(255));";
    private static final String DATABASE_CREATE4 = "CREATE TABLE list_product (id_list_fk integer, _id integer, quantita integer,PRIMARY KEY(id_list_fk,_id) ,FOREIGN KEY (id_list_fk) REFERENCES list(_id),FOREIGN KEY (_id) REFERENCES product(_id));";
